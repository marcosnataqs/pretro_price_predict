...
class LakeConnector():
    ...
    def azure_connection(self, container_name: str, 
                         blob_name:str, 
                         connection_string:str) -> BlobClient:
    ...
    def aws_connection(self, aws_access_key_id:str, 
                       aws_secret_access_key:str, 
                       aws_session_token:str) -> boto3.client:
    ...
    def connect(self, file_path:str) -> Any:
        ...
        if self.service_provider.lower() == "azure":
            connection = self.azure_connection(container_name=os.environ["AZURE_CONTAINER_NAME"] , 
                                               blob_name = file_path, 
